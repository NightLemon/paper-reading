...
| 论文 | 年份 | 来源 | 状态 | 一句话 |
| --- | --- | --- | --- | --- |
| [Orca: A Distributed Serving System for Transformer-Based Generative Models](2022-orca/README.md) | 2022 | OSDI'22 | ✅ 已完成 | 把调度粒度从请求降到迭代，再用 selective batching 让形状不齐的请求仍能合批 |
...
| [Mooncake: A KVCache-centric Disaggregated Architecture for LLM Serving](2025-mooncake/README.md) | 2025 | FAST'25 | ✅ 已完成 | 把集群闲置的 CPU/DRAM/SSD/RDMA 攒成共享 KVCache 池，调度围绕缓存分布做，并处理长期过载 |

...
| [Continuous Batching](continuous-batching.md) | 连续批处理、iteration-level scheduling | 调度 | Orca · vLLM |
...
| [IO-aware 算法设计](io-aware-kernel-design.md) | IO-Awareness、tiling | GPU 性能 | FlashAttention |
| [张量并行](tensor-parallelism.md) | Tensor Parallelism、TP | 分布式训练 | Megatron-LM |
| [共识与复制状态机](consensus-and-replication.md) | Consensus、quorum | 分布式系统 | Raft |
